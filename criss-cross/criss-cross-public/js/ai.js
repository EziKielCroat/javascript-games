...
Array.from(elements).forEach(function(element) {
    element.addEventListener('click', function() {
        if(document.getElementById(element.id).classList == "block") {
            addMove("O", element);
            checkWin();
            checkTie();
            addMoveBot();
...
function addMoveBot() {
    ...
    if(document.getElementById("block_" + number).innerHTML == "") {
        document.getElementById("block_" + number).innerHTML = "X";
    } else {
        addMoveBot();
    }
}
